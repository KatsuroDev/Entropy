...
ifeq ($(OS), Windows_NT)
LINKER_FLAGS = -I./inc/ -L./lib/Windows -static -std=c++14 -std=gnu++14 -Wunused-parameter -Wstrict-aliasing -lmingw32 -lglew32s -lglfw3 -llibSOIL -lopengl32 -lglu32 -lgdi32 -dl #-I"./inc/steam/" -lsteam_api #-llua53 -dl
endif
